...
export interface SentenceFragment {
  ...
  targetTranslation?: string;  // Ukrainian translation of sentence to assemble
  wordHints?: Record<string, string>; // Hints/translations for individual word chips
}
...
export const DETECTIVE_CASES: DetectiveCase[] = [
  {
    ...
    steps: [
      ...
      // 5. Конструктор речення: Розірвана записка кур'єра
      {
        ...
        instruction: 'Під лавкою виявлено розірвану записку кур\'єра дипломатичної пошти. Відновіть первинний зміст фрази: «Візьміть валізу і йдіть тільки прямо» (відкиньте зайві слова-пастки!):',
        characterName: 'Еркюль Пуаро',
        characterRole: 'Метр детективу',
        characterAvatar: '🕵️‍♂️',
        poirotEmotion: 'thinking',
        poirotCommentary: 'Зберіть ці фрагменти докупи, як мозаїку. Нам потрібна фраза: «Візьміть валізу і йдіть тільки прямо». Пам\'ятайте наше правило: «направо» болгарською означає «прямо»!',
        sentenceFragments: {
          targetTranslation: '«Візьміть валізу і йдіть тільки прямо»',
          ...
          wordHints: {
            ...
            'само': 'тільки',
            'направо': 'прямо',
            'надясно': 'праворуч (пастка)',
            'стая': 'кімната (пастка)',
          },
        },
        audioText: 'Вземете куфара и вървете само направо.',
        xpReward: 20,
      },
  ...
  },
  {
    ...
    steps: [
      ...
      // 8. Відновлення записки: Розірвана телеграма (sentence_assembly)
      {
        ...
        instruction: 'Складіть знайдені в кошику з хлібом клаптики телеграми: «Сапфір захований близько біля вікна»:',
        characterName: 'Еркюль Пуаро',
        characterRole: 'Метр детективу',
        characterAvatar: '🕵️‍♂️',
        poirotEmotion: 'alert',
        poirotCommentary: 'Злочинці переписувалися короткими кодованими фразами. Відновіть повідомлення: «Сапфір захований близько біля вікна»!',
        sentenceFragments: {
          targetTranslation: '«Сапфір захований близько біля вікна»',
      ...
      // 17. Відновлення зізнання: Чорновик каяття офіціанта (sentence_assembly)
      {
        ...
        instruction: 'Офіціант Радослав почав писати зізнання на серветці, але порвав його. Відновіть ключове речення: «Я взяв сапфір і сховав його в кошик»:',
        characterName: 'Радослав',
        characterRole: 'Офіціант вагона-ресторану',
        characterAvatar: '🧑‍🍳',
        poirotEmotion: 'alert',
        poirotCommentary: 'Усі шматки головоломки сходяться! Відновіть його слова: «Я взяв сапфір і сховав його в кошик», перш ніж висунути звинувачення!',
        sentenceFragments: {
          targetTranslation: '«Я взяв сапфір і сховав його в кошик»',
