    ...
    steps: [
      ...
      // 5.5 Обшук кімнати мансарди
      {
        ...
        crimeScene: {
          ...
          backgroundImage: '/images/crime-scenes/mansarda-42.jpg',
          hotspots: [
            {
              id: 'hs-door',
              objectName: 'Врата (двері)',
              position: { x: 2, y: 12, width: 14, height: 75 },
              wordBg: 'врата',
              transcription: '[вра́та]',
              translationUa: 'двері',
              isEvidence: false,
              poirotHint: 'На дверях викарбувано «Mansarda 42». Замок цілий — злодій мав дублікат ключа!',
            },
            {
              id: 'hs-bed',
              objectName: 'Легло (ліжко)',
              position: { x: 19, y: 46, width: 24, height: 38 },
              wordBg: 'легло',
              transcription: '[легло́]',
              translationUa: 'ліжко',
              isEvidence: false,
              poirotHint: 'Ліжко з вишневою ковдрою. Під подушкою нічого підозрілого немає.',
            },
            {
              id: 'hs-window',
              objectName: 'Прозорец (вікно)',
              position: { x: 46, y: 8, width: 16, height: 32 },
              wordBg: 'прозорец',
              transcription: '[прозо́рец]',
              translationUa: 'вікно',
              isEvidence: false,
              poirotHint: 'Мансардне арочне вікно зачинене зсередини на шпінгалет. Нічне небо Софії чисте.',
            },
            {
              id: 'hs-carpet',
              objectName: 'Килим (килим)',
              position: { x: 38, y: 72, width: 28, height: 24 },
              wordBg: 'килим',
              transcription: '[кили́м]',
              translationUa: 'килим',
              isEvidence: true,
              poirotHint: 'Sacré bleu! Під килимом — відігнута дошка паркету! А в щілині блищить запасний ключ від мансарди!',
            },
            {
              id: 'hs-chair',
              objectName: 'Стол (стілець)',
              position: { x: 63, y: 54, width: 13, height: 33 },
              wordBg: 'стол',
              transcription: '[стол]',
              translationUa: 'стілець (!)',
              isEvidence: false,
              poirotHint: 'Ось вона, головна пастка! Болгарський «стол» — це СТІЛЕЦЬ біля робочого місця!',
            },
            {
              id: 'hs-table',
              objectName: 'Маса (стіл)',
              position: { x: 72, y: 52, width: 25, height: 42 },
              wordBg: 'маса',
              transcription: '[ма́са]',
              translationUa: 'стіл (письмовий/обідній)',
              isEvidence: false,
              poirotHint: 'Письмовий стіл («маса») з лампою та друкарською машинкою. З нього й викрали секретні креслення!',
            },
          ],
        },
